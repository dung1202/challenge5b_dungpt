...
<div class="row">
    ...
    <div class="col-12">
        <span>Đề bài</span>
        <?php $__currentLoopData = $exercise->file;
    ...
    <div class="col-12">
        ...
        <?php $__currentLoopData = $submits;
        $__env->addLoop($__currentLoopData);
        foreach ($__currentLoopData as $submit) : $__env->incrementLoopIndices();
            $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <?php $__currentLoopData = $submit->file_submit;
                    $__env->addLoop($__currentLoopData);
                    foreach ($__currentLoopData as $item) : $__env->incrementLoopIndices();
                        $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(asset($item)); ?>" style="display: block;"><?php echo e(asset($item)); ?></a>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bluecyber_laravel-8x\resources\views/exercise/show_exercise.blade.php ENDPATH**/ ?>